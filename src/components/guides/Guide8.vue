...
import imageDoOne from '@/assets/images/guide-8/image_do_1.png';
import imageDontOne from '@/assets/images/guide-8/image_dont_1.png';
...
import imageDoThree from '@/assets/images/guide-8/image_do_3.png';
import imageDontThree from '@/assets/images/guide-8/image_dont_3.png';
        ...
        <Challenge time="1" :id="7" :tasks="challenge7_tasks">
           Mejora el UX Writing de un evento de la pagina de eventos de la UNHEVAL.
            <template v-slot:tools>
                <ResourceLink name="Keep" type="tool">
                    <ResourceCard
                        title="Keep"
