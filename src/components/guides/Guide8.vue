...
import imageOne from '@/assets/images/guide-8/image_1.png'
import imageTwo from '@/assets/images/guide-8/image_2.png'
import imageThree from '@/assets/images/guide-8/image_3.png'
...
<template>
    ...
    <GuideBody>
        ...
        <Heading type="h1" id="guide_8_title_2">¿Por qué usamos flujos de usuario?</Heading>
        <section>
            ...
            <Heading type="h2" id="guide_8_title_3">Crear una interfaz intuitiva</Heading>
            ...
            <Heading type="h2" id="guide_8_title_4">Evaluar las interfaces existentes</Heading>
            ...
            <Heading type="h2" id="guide_8_title_5">Presentar su producto a clientes o colegas</Heading>
        ...
        <Heading type="h1" id="guide_8_title_6">¿Cuándo hacer los flujos de usuario?</Heading>
        <section>
        ...
        <Heading type="h1" id="guide_8_title_7">Tipos de diagramas de Flujo de Usuario</Heading>
        <section>
            ...
            <Heading type="h2" id="guide_8_title_8">Flujos de Tareas</Heading>
            ...
            <Heading type="h2" id="guide_8_title_9">Wireflows</Heading>
            ...
            <Heading type="h2" id="guide_8_title_10">Flujos de Usuario</Heading>
