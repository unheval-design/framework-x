...
<template>
    ...
    <GuideBody>
        <h1 id="guide_5_title_1">Definición</h1>
        <section>
            <p>
        ...
        <h1 id="guide_5_title_2">¿Cuándo usar el Card Sorting?</h1>
        <section>
            <p>
        ...
        <h1 id="guide_5_title_3">Ventajas y Desventajas</h1>
        <section>
            <h2 id="guide_5_title_4">Ventajas</h2>
            <p>
                <ul>
            ...
            <h2 id="guide_5_title_5">Desventajas</h2>
            <p>
                <ul>
        ...
        <section>
            ...
            <h2 id="guide_5_title_8">Cerrada</h2>
            ...
            <Reference
                :image="imageTwo"
                description="Open Card Sort. Fuente: interaction-design.org" />
            <h2 id="guide_5_title_9">Híbrida</h2>
        ...
        <h1 id="guide_5_title_10">¿Que herramientas usar para hacer Card Sorting?</h1>
        <section>
        ...
        <h1 id="guide_5_title_11">Evaluación</h1>
        <section>
