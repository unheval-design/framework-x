...
const question1 = {
    ...
    answer: 1,
    alternatives: [
        'En probar dos o mas versiones de nuestro producto con dos grupos de usuarios.',
        'En probar dos veces nuestro producto con dos grupos de usuarios diferentes.',
        'En probar dos productos diferentes para encontrar mejoras y errores entre estos.'
    ]
};

const question2 = {
    question:
        '¿Cuándo necesitamos usar la prueba de los cinco segundos?',
    answer: 3,
    alternatives: [
        'Si necesito saber si los usarios entienden la finalidad del producto en un tiempo muy corto.',
        'Cuando quiero saber si mis usuarios pueden cumplir una tarea importante en cinco segundos.',
        'Si necesito comprobar la optimizacion y velocidad con la que cargan los elementos en mi interfaz.'
    ]
};
</script>
