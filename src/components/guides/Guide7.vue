...
<template>
    ...
    <GuideBody>
        <h1 id="guide_7_title_1">Definición</h1>
        <section>
            <p>
        ...
        <h1 id="guide_7_title_2">¿Por qué usamos flujos de usuario?</h1>
        <section>
            ...
            <h2 id="guide_7_title_3">Crear una interfaz intuitiva</h2>
            ...
            <h2 id="guide_7_title_4">Evaluar las interfaces existentes</h2>
            ...
            <h2 id="guide_7_title_5">Presentar su producto a clientes o colegas</h2>
        ...
        <h1 id="guide_7_title_6">¿Cuándo hacer los flujos de usuario?</h1>
        <section>
        ...
        <h1 id="guide_7_title_7">Tipos de diagramas de Flujo de Usuario</h1>
        <section>
            ...
            <h2 id="guide_7_title_8">Flujos de Tareas</h2>
            ...
            <h2 id="guide_7_title_9">Wireflows</h2>
            ...
            <h2 id="guide_7_title_10">Flujos de Usuario</h2>
        ...
        <h1 id="guide_7_title_11">Evaluación</h1>
        <section>
